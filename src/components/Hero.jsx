...
//       {/* Background Image */}
//       <div
//         className="absolute inset-0 bg-cover bg-center bg-[url('/images/Rectangle1.png')]"
//         style={{
...
//       {/* Hero Content */}
//       <div className="relative z-10 flex flex-col  justify-end h-4/5  w-[65%] mx-auto px-6 text-white ">
//         <div>
...
//             <a
//               href="#"
//               className="px-6 py-3 bg-teal-400 text-white text-lg font-medium rounded-md hover:bg-teal-500 transition inline-flex items-center"
//             >
